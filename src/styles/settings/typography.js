...
const { msRange, ms2rem, px2em } = require('./tailwind.utils')
...
const sizes = R.compose(
	...
	xlh: {
		min: ms2rem(5),
		max: ms2rem(22),
		debug: `${rem2px(ms2rem(5))}px ${rem2px(ms2rem(22))}px`
	},
	...
	xxl: {
		min: ms2rem(9),
		max: ms2rem(17),
		debug: `${rem2px(ms2rem(9))}px ${rem2px(ms2rem(17))}px`
	},
	...
	hero: {
		min: ms2rem(1),
		max: ms2rem(20),
		debug: `${rem2px(ms2rem(1))}px ${rem2px(ms2rem(20))}px`
	},

	lg: {
		min: ms2rem(1),
		max: ms2rem(8),
		debug: `${rem2px(ms2rem(1))}px ${rem2px(ms2rem(8))}px`
	},

	sec: {
		min: ms2rem(5),
		max: ms2rem(15),
		debug: `${rem2px(ms2rem(5))}px ${rem2px(ms2rem(15))}px`
	},

	md: {
		min: ms2rem(0),
		max: ms2rem(7),
		debug: `${rem2px(ms2rem(0))}px ${rem2px(ms2rem(7))}px`
	},
	...
	midget: {
		min: ms2rem(-4),
		max: ms2rem(8),
		debug: `${rem2px(ms2rem(-4))}px ${rem2px(ms2rem(8))}px`
	}
})
...
const fonts = {
	regular: ['GT-Walsheim-Light', 'Century Gothic', 'helvetica', 'Arial'],

	bold: ['GT-Walsheim-Medium', 'Century Gothic', 'helvetica', 'Arial']
}
